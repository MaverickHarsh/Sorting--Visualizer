...
function quick_partition (start, end)
{
    ...
    div_update(divs[start],div_sizes[start],"yellow",start);//Color update
    ...
    div_update(divs[start],div_sizes[start],"red",start);//Color update
    ...
    div_update(divs[start],div_sizes[start],"red",start);//Height update
